...
# in: composite image filenames
# out: name of individual images
...
# input: mass DataFrame
# output: response latency (reaction time task)
def plot_rl(mass):
...
def rating_pull(tuple_rating_list):
    ...
    '''
    if tuple_rating_list == None:
        return('None')
    elif len(tuple_rating_list)>1:
