...
main_dir = '/Users/kirstenziman/Desktop/';
...
for x=[1:numel(file_list_1a)];
    ...
    comp_name = strcat('/Users/kirstenziman/Desktop/composites_even/', file_list_1(x).name(1:length(file_list_1a(x).name)-length(file_ext)), '_', name2, file_ext);
...
for x=[1:numel(file_list_1b)]
    ...
    % composite image filename (combo of original file names)
    comp_name = strcat('/Users/kirstenziman/Desktop/composites_even/', file_list_1b(x).name(1:length(file_list_1b(x).name)-length(file_ext)), '_', file_list_2(x).name(1:length(file_list_2(x).name)-length(file_ext)), file_ext);
